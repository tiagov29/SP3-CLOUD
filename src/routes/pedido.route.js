...
const user = require('../controllers/pedidos.controllers.js');
const adminAcces = require('../middlewares/validationToken.js');
...
lRoutes.get('/verPedido', user.checkOrder);
...
lRoutes.get('/verHistorialPedidos', user.getAllOrders);
...
lRoutes.post('/producto/:_id', user.addProduct);
...
lRoutes.delete('/producto/:_id', user.deleteProduct);
...
lRoutes.put('/medioDePago/:_id', user.updatePaymentMethod);
...
lRoutes.put('/cambioDireccion/:_id', user.updateAddress);
...
lRoutes.put('/direccionGuardada/:_id', user.addAddress);
...
lRoutes.put('/confirmarPedido/:_id', user.confirmOrder);
 ...
 *              description: acceso denegado
 */
lRoutes.post('/:_id', user.createOrder);


//middlewareAdmin
lRoutes.use(adminAcces.AdministrationToken);
...
lRoutes.put('/cambiarEstadoPedido/:_id', user.updateOrderState);
