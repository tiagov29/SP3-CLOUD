...
const user = require('../controllers/products.controllers.js');
 ...
 */
pRoute.get('/', adminAcces.cache,user.GetProducts);
 ...
 */
pRoute.post('/', user.createProduct);
...
pRoute.put('/:_id', user.updateProduct, adminAcces.cache);
 ...
 */
pRoute.delete('/:_id', user.deleteProduct);
